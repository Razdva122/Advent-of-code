function crossedWires(movesOfFirstWire: Array<string>, movesOfSecondWire: Array<string>) :number {
  ...
  for (let i = 0; i < movesOfSecondWire.length; i += 1) {
    const direction: directions = movesOfSecondWire[i].slice(0, 1) as directions;
